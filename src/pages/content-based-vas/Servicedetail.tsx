...
const ServiceDetailSection: React.FC<ServiceDetailProps> = ({
  ...
  description = "We design and manage subscription based and on demand content services across SMS and web platforms. Our solutions support education, information, lifestyle, gaming, and entertainment use cases.",
  keyFeaturesTitle = "Key Features",
  keyFeatures = [
    "SMS and web content delivery.",
    "Daily, weekly, and on-demand subscription models.",
    "Content lifecycle management from launch to sunset.",
